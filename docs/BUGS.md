...
This site contains intentional bugs for testing the AI QA Engineer.
...
```bash
# Via GitHub Actions
Go to Actions → AI QA Engineer → Run workflow
URL: https://tyler-james-bridges.github.io/ai-qa-engineer/
